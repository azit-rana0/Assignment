...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateTestimonials(index) {
        ...
        testimonials.forEach((testimonial, i) => {
            testimonial.style.zIndex = (index === i) ? 3 : (index - i === 1 || i - index === testimonials.length - 1) ? 2 : 1;
    ...
    prevButton.addEventListener('click', function() {
        currentIndex = (currentIndex - 1 + testimonials.length) % testimonials.length;  // Volta para o testimonial anterior
        updateTestimonials(currentIndex);
    });
...
function updateTestimonials() {
  ...
  testimonials[currentIndex].style.boxShadow = '0px 100px 80px rgba(0, 0, 0, 0.02), 0px 64.8148px 46.8519px rgba(0, 0, 0, 0.0151852), 0px 38.5185px 25.4815px rgba(0, 0, 0, 0.0121481), 0px 20px 13px rgba(0, 0, 0, 0.01), 0px 8.14815px 6.51852px rgba(0, 0, 0, 0.00785185), 0px 1.85185px 3.14815px rgba(0, 0, 0, 0.00481481)';
